...
export default function AdminHome() {
  ...
  const handleCreate = async () => {
    ...
    if (!name.trim() || !date.trim()) {
      if (Platform.OS === "web") window.alert("Name and date are required");
      else Alert.alert("Missing fields", "Name and date are required");
      return;
    }
    setSubmitting(true);
    try {
  ...
  const handleDelete = async (id: string) => {
    ...
    const ok =
      Platform.OS === "web"
        ? window.confirm("Delete this event and all its photos?")
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "left", "right"]}>
      <View style={styles.topBar}>
        <TouchableOpacity onPress={() => router.replace("/")} testID="back-to-public">
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            <Text style={styles.overline}>ADMIN DASHBOARD</Text>
            <Text style={styles.title}>
              Your <Text style={styles.italic}>events</Text>.
            </Text>
          ...
          <ScrollView contentContainerStyle={styles.sheetScroll} keyboardShouldPersistTaps="handled">
            <View style={styles.sheet}>
              ...
              <TextInput
                ...
                placeholder="A Cuban night at Le Cabaret Sauvage..."
                placeholderTextColor={COLORS.secondaryText}
                value={description}
              ...
              >
                {cover ? (
                  ...
                  <View style={styles.coverEmpty}>
                    ...
                    />
                    <Text style={styles.coverEmptyTxt}>TAP TO SELECT</Text>
                  </View>
                )}
              </TouchableOpacity>
